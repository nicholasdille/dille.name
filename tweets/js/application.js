...
//
  var templates = {
    ...
    user_nav: Hogan.compile('<a href="#" class="icon-sprite icon-user dropdown-toggle" data-toggle="dropdown"></a><ul class="dropdown-menu"><li><a href="#user-info" data-toggle="modal"><i class="icon-user"></i>Account-Details anzeigen</a></li><li class="divider"></li><li><a href="https://twitter.com/{{screen_name}}" target="_blank"><i class="icon-share-alt"></i>Profil auf Twitter anzeigen</a></li></ul>'),
    modal_header: Hogan.compile('<h3>Account-Details <span class="download-date muted">ab {{created_at_relative}}</span></h3>'),
    ...
    modal_account_details: Hogan.compile('<p>#{{id}} <span class="footer-label muted">Benutzerkennung</span></p><p class="truncated">{{created_at_relative}} <span class="footer-label muted">Beigetreten</span></p>'),
...
//
  ...
  exports.init = function () {
    ...
    .bind('invalidSearch', function (e) {
      e.preventDefault();
      $(this)
        .attr('data-original-title', 'Deine Suchanfrage muss aus mindestens zwei Zeichen bestehen.')
        .tooltip('show');
    });
  ...
  (function(exports) {
    exports.base = {
      init: function () {
        $('.navbar-search .search-query').attr('placeholder', 'Alle Tweets durchsuchen');
  ...
  (function (exports){
    ...
    exports.localizeStrings = function() {
      ...
      document.title = "Dein Twitter Archiv";
      $('#footer-text').append("Dies ist ein Offline-Archiv Deiner Tweets von Twitter. Nutze die obenstehenden Monate, um das Archiv zu navigieren.");
      var compose_new_tweet = "Neuen Tweet verfassen";
